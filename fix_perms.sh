...
chmod -R 700 nonvoting_mixnet_mailproxy/conf/provider?
chmod -R 700 nonvoting_mixnet_mailproxy/conf/mix?
chmod -R 700 nonvoting_mixnet_mailproxy/conf/auth
chmod -R 700 nonvoting_mixnet_mailproxy/conf/mailproxy
